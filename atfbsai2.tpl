...
//!!cout<<"nsamples_srv_age"<<std::endl;
//!!cout<<nsamples_srv_age<<std::endl;  
//!!cout<<"nsurv_aged"<<std::endl;
//!!cout<<nsurv_aged<<std::endl;
//!!cout<<"nobs_srv_age"<<std::endl;
//!!cout<<nobs_srv_age<<std::endl;
...
!!cout<<"obs_p_srv1_age"<<std::endl;
!!cout<<obs_p_srv1_age<<std::endl;
  init_3darray obs_p_srv3_age(1,2,1,nobs_srv3_age,1,nages)  //(57) AI survey age comps by sex and year
!!cout<<"obs_p_srv3_age"<<std::endl;
!!cout<<obs_p_srv3_age<<std::endl;
//  init_4darray obs_p_srv_age(1,nsurv_aged,1,2,1,nobs_srv_age,1,nages) //57.5
//!!cout<<"obs_p_srv_age"<<std::endl;
//!!cout<<obs_p_srv_age<<std::endl;
